...
export default function Faqs() {
  const faqs = [
    {
      icon: <Smile className="w-5 h-5 text-btnBackgroundhover" />,
    ...
    {
      icon: <Repeat className="w-5 h-5 text-btnBackgroundhover" />,
      question: "What is your cancellation policy?",
      answer: "We understand that things change. You can cancel your plan at any time and we'll refund you the difference already paid.",
    },
    {
      icon: <CreditCard className="w-5 h-5 text-btnBackgroundhover" />,
      question: "How does billing work?",
      answer: "Plans are per workspace, not per account. You can upgrade one workspace and still have any number of free workspaces.",
    },
    {
      icon: <Edit className="w-5 h-5 text-btnBackgroundhover" />,
    ...
    {
      icon: <Info className="w-5 h-5 text-btnBackgroundhover" />,
    ...
    {
      icon: <Mail className="w-5 h-5 text-btnBackgroundhover" />,
    ...
    {
      icon: <Calendar className="w-5 h-5 text-btnBackgroundhover" />,
    ...
    {
      icon: <Globe className="w-5 h-5 text-btnBackgroundhover" />,
    ...
    {
      icon: <Shield className="w-5 h-5 text-btnBackgroundhover" />,
    ...
    {
      icon: <Settings className="w-5 h-5 text-btnBackgroundhover" />,
